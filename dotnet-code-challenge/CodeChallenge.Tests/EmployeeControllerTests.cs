...
namespace CodeCodeChallenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        /**
        * There is a bug in which the altering of employees in the tests below does not also alter the reporting structure,
        * meaning the data that for testing the reporting structure isn't reliable from test to test. 
        * Fixing this bug I think is out of scope of the challenge, so I chose the simple solution of running the 
        * my tests chronologically first. Ideally, each test should be able to be run individually and cleanup after itself.
        */
        [TestMethod]
        ...
        [TestMethod]
        public void GetReportingStructure_On_Null()
        {
            // Arrange
        ...
        [TestMethod]
        public void GetReportingStructure_On_NotFound()
        {
            // Arrange
            var employeeId = "this-is-a-false-id";
        ...
        public void CreateCompensation_Returns_Created()
        {
            ...
            var compensation = new Compensation()
            {
                ...
                Salary = 143327.23,
                EffectiveDate = "1705434521"
            };

            var requestContent = new JsonSerialization().ToJson(compensation);

            // Execute
            var postRequestTask = _httpClient.PostAsync($"api/employee/compensation/{compensation.EmployeeId}",
        ...
        public void GetCompensation_Returns_OK()
        {
            ...
            Assert.IsNotNull(returnedCompensation.Salary);
            Assert.IsNotNull(returnedCompensation.EffectiveDate);
        }
